        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <DictionaryCard className="md:col-span-2">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-600 dark:text-zinc-400">
              ...
              <strong className="text-slate-800 dark:text-zinc-200">100 is perfectly average</strong>.
      ...
      >
        <div className="space-y-6">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <DictionaryCard>
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">K% and BB%</h3>
            ...
            <DictionaryCard>
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">K-BB%</h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-zinc-400">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-200 text-slate-600 dark:divide-zinc-800 dark:text-zinc-400">
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">IP</td>
                <td className="px-6 py-4">
                  Innings pitched, tracked in thirds of an inning.
                </td>
              </tr>
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">ERA</td>
                <td className="px-6 py-4">
                  Earned runs allowed per 9 innings.
                </td>
              </tr>
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">WHIP</td>
                <td className="px-6 py-4">
                  Walks plus hits allowed per inning pitched.
                </td>
              </tr>
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">W / L</td>
                <td className="px-6 py-4">
                  Wins and losses credited to the pitcher of record.
                </td>
              </tr>
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">SV</td>
                <td className="px-6 py-4">Saves credited in qualifying close games.</td>
              </tr>
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-slate-900 dark:text-zinc-50">GS</td>
