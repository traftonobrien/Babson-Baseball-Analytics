      ...
      >
        <div className="space-y-6">
          <DictionaryCard className="sm:px-8">
            ...
            <ul className="mt-4 list-disc space-y-1.5 pl-5 text-sm text-slate-600 dark:text-zinc-400">
              <li>
                <strong className="text-slate-800 dark:text-zinc-200">Fastballs:</strong> Positive
                IVB creates ride and keeps the ball above the barrel.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-zinc-200">Breaking Balls:</strong>{" "}
          ...
          <DictionaryCard className="sm:px-8">
            ...
            <ul className="mt-4 list-disc space-y-1.5 pl-5 text-sm text-slate-600 dark:text-zinc-400">
              <li>
                <strong className="text-slate-800 dark:text-zinc-200">Positive HB:</strong> The ball
                moves to the right from the pitcher&apos;s perspective.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-zinc-200">Negative HB:</strong> The ball
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <DictionaryCard>
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">Extension</h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-zinc-400">
            ...
            <DictionaryCard className="sm:col-span-2">
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">Spin Rate</h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-zinc-400">
        ...
        <DictionaryTableShell>
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-200 text-slate-600 dark:divide-zinc-800 dark:text-zinc-400">
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                <td className="px-6 py-4 font-mono font-medium text-blue-400">FB</td>
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Four-Seam Fastball</td>
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Sinker / Two-Seam</td>
                <td className="hidden px-6 py-4 sm:table-cell">
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Slider</td>
                <td className="hidden px-6 py-4 sm:table-cell">
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Curveball</td>
                <td className="hidden px-6 py-4 sm:table-cell">
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Changeup</td>
                <td className="hidden px-6 py-4 sm:table-cell">
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Cutter</td>
                <td className="hidden px-6 py-4 sm:table-cell">
              ...
              <tr className="hover:bg-slate-50 transition-smooth dark:hover:bg-zinc-900/80">
                ...
                <td className="px-6 py-4 text-slate-900 dark:text-zinc-50">Splitter</td>
                <td className="hidden px-6 py-4 sm:table-cell">
