                        ...
                        <div className="bg-orange-950/20 border border-orange-500/20 rounded-xl p-6">
                            ...
                            <div className="space-y-4">
                                <p className="text-sm text-orange-200/70 leading-relaxed">
                                    Command+ is a live, pitch-weighted metric that compares a pitcher&apos;s command relative to the team&apos;s current-season average for that same pitch type. An overall Command+ score of 100 means the pitcher has exactly average command across their arsenal. Higher is better.
                                </p>
                                <div className="bg-orange-950/40 border border-orange-900/50 rounded-lg p-4 mt-4">
                                    ...
                                    <ul className="list-disc list-inside text-sm text-orange-200/60 space-y-2">
                                        <li><strong>Pitch-Specific Baseline:</strong> First, we calculate the team&apos;s live season average absolute miss distance for every valid pitch type (e.g., the team averages 12&quot; of miss on Fastballs and 18&quot; on Curveballs).</li>
                                        ...
                                        <li><strong>Eligibility:</strong> Pitch rows tagged as blank, unknown, or <code className="bg-orange-950 px-1 py-0.5 rounded text-orange-300">OTHER</code> are excluded from the official Command+ baseline and score.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
