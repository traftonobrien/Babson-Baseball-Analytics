...
export default function StuffPlusModelCard({
  ...
  return (
    <section className="rounded-[2rem] border border-blue-200 bg-[radial-gradient(circle_at_top_left,rgba(191,219,254,0.30),transparent_28%),linear-gradient(135deg,#eff6ff_0%,#ffffff_62%,#f8fbff_100%)] p-6 shadow-[0_22px_52px_rgba(15,23,42,0.07)] dark:border-blue-500/30 dark:bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.2),transparent_30%),linear-gradient(135deg,rgba(10,37,74,0.76)_0%,rgba(24,24,27,0.92)_56%,rgba(9,9,11,0.98)_100%)] dark:shadow-[0_22px_52px_rgba(0,0,0,0.4)]">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-blue-700 dark:text-blue-200">
              Stuff+ Arsenal
            </p>
          </div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-600 dark:text-zinc-400">
            The profile <span className="font-mono text-slate-700 dark:text-zinc-200">Stuff+</span>
        ...
        {overall != null ? (
          ...
          <div className="inline-flex min-w-[8rem] items-center justify-center rounded-2xl border border-blue-200 bg-surface px-4 py-3 font-mono text-sm font-black uppercase tracking-[0.18em] text-slate-500 dark:border-blue-500/35 dark:bg-zinc-900/80 dark:text-zinc-300">
            Not Ready
          </div>
        )}
      </div>
      ...
      <div className="mt-5 rounded-2xl border border-blue-200 bg-blue-50/70 px-4 py-3 text-[12px] leading-6 text-slate-600 dark:border-blue-500/35 dark:bg-blue-950/35 dark:text-zinc-300">
        This standalone card can differ from <span className="font-mono text-slate-700 dark:text-zinc-200">Stuff Core</span>
            ...
            >
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-[12px] font-bold text-slate-900 dark:text-zinc-50">
