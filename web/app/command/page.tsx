...
function LightPill({
  ...
  const toneClassName = {
    neutral: "border-slate-200 dark:border-zinc-700 bg-background text-slate-500 dark:text-zinc-400",
    brand:
...
function PlayerNamePill({ name }: { name: string }) {
  return (
    <span className="inline-flex min-w-0 max-w-full items-center rounded-full border border-slate-200 dark:border-zinc-700 bg-surface px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-900 dark:text-zinc-50 shadow-[0_1px_0_rgba(15,23,42,0.02)]">
  ...
  return (
    <div ref={rootRef} className={`w-full min-w-0 space-y-2 ${className ?? ""}`}>
      ...
      >
        ...
        <ChevronDown
          className={`h-4 w-4 shrink-0 text-slate-400 dark:text-zinc-500 transition-transform duration-300 ${open ? "rotate-180" : ""}`}
        />
      </button>
      {menu}
    </div>
...
function RowChevron() {
  return (
    <span className="flex h-8 w-8 items-center justify-center rounded-2xl border border-slate-200 dark:border-zinc-700 bg-background">
                        ...
                        <Link
                          ...
                          className={`flex flex-col gap-3 rounded-[1.35rem] border px-4 py-3 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.04)] sm:flex-row sm:items-center sm:justify-between ${
                            isSelected
                              ...
                              : "border-slate-200 dark:border-zinc-700 bg-surface hover:border-slate-300 dark:hover:border-zinc-600"
                    ...
                    return (
                      <div
                        ...
                        className={`overflow-hidden rounded-[1.45rem] border ${
                          isSelected
                            ? "border-[var(--brand-primary-border)] bg-[var(--brand-primary-soft)]"
                            : "border-slate-200 dark:border-zinc-700 bg-surface"
                        } ${rowTransition.className}`}
                        style={rowTransition.style}
                      >
                        <button
                        ...
                        >
                          ...
                          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl border border-slate-200 dark:border-zinc-700 bg-background">
                            <ChevronDown
                              className={`h-4 w-4 text-slate-400 dark:text-zinc-500 transition-transform duration-300 ${
