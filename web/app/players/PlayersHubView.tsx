      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-10">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-zinc-900 border border-zinc-800 rounded-lg pl-9 pr-3 py-2.5 text-sm text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-zinc-600 transition-colors"
          />
        </div>
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    <h2 className="text-lg font-semibold text-zinc-100 truncate group-hover:text-zinc-50 transition-colors">
