      ...
      >
        <div className="space-y-6">
          <DictionaryCard className="sm:px-8">
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">Search and Filters</h3>
          ...
          <DictionaryCard className="sm:px-8">
            <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-50">Profile Routing</h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-zinc-400">
